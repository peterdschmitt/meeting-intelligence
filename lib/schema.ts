...
export const companyTypeEnum = pgEnum('company_type', ['Portfolio', 'Prospect', 'Service Provider']);
export const actionStatusEnum = pgEnum('action_status', ['open', 'in_progress', 'done']);
export const priorityEnum = pgEnum('priority', ['low', 'medium', 'high', 'critical']);
export const meetingSourceEnum = pgEnum('meeting_source', ['manual', 'gdrive', 'voice']);
